...
if(!isset($SEARCH_SHORTCODE)) 
{
	...
	$SEARCH_SHORTCODE = "<div id='top-search' class='input-group'>
                         <input class='form-control search-box' type='text' name='q' size='20' value='' placeholder='".LAN_SEARCH."' maxlength='50' />
