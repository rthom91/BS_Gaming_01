...
$NEWS_MENU_TEMPLATE['category']['item']        = '<li><a class="e-menu-link newscats{active}" href="{NEWS_CATEGORY_URL}"><span class="badge pull-right">{NEWS_CATEGORY_NEWS_COUNT}</span>{NEWS_CATEGORY_TITLE}</a></li>
';
...
$NEWS_MENU_TEMPLATE['months']['item']        = '<li><a class="e-menu-link newsmonths{active}" href="{url}"><span class="badge pull-right">{count}</span>{month}</a></li>
';
...
$NEWS_MENU_TEMPLATE['latest']['item']        = '<li><a class="e-menu-link newsmonths" href="{NEWSURL}"><span class="badge pull-right">{NEWSCOMMENTCOUNT}</span>{NEWSTITLE}</a></li>';
...
$NEWS_MENU_TEMPLATE['other']['item']		= '<div class="item {ACTIVE}">
              									             ...
              									             <h3>{NEWSTITLE}</h3>
              									             <p>{NEWSSUMMARY}</p>
              									             <p class="text-right"><a class="btn btn-primary btn-xs btn-othernews" href="{NEWSURL}">'.LAN_READ_MORE.'</a></p>
            									             </div>';									
...
$NEWS_MENU_TEMPLATE['other2']['start'] 	= "<ul class='media-list unstyled othernews2-block'>{SETIMAGE: w=80&h=80&crop=1}"; // set the {NEWSIMAGE} dimensions. 	
$NEWS_MENU_TEMPLATE['other2']['item'] 	= "<li class='media'>
										                         <span class='media-object pull-left'>{NEWSTHUMBNAIL=placeholder}</span> 
										                         <div class='media-body'>
                                               <h4>{NEWSTITLELINK}</h4>
										                           <p class='text-right'><a class='btn btn-primary btn-xs btn-othernews2' href='{NEWSURL}'>".LAN_READ_MORE."</a></p>
										                         </div>
										                       </li>\n";
