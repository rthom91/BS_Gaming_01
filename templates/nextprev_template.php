...
$NEXTPREV_TEMPLATE['bootstrap_nav_first'] 		= '<li><a class="first hidden-xs" href="{url}" title="{url_label}"><i class="fa fa-angle-double-left"></i></a></li>';
$NEXTPREV_TEMPLATE['bootstrap_nav_prev'] 		= '<li><a class="prev" href="{url}" title="{url_label}"><i class="fa fa-angle-left"></i></a></li>';
$NEXTPREV_TEMPLATE['bootstrap_nav_last'] 		= '<li><a class="last hidden-xs" href="{url}" title="{url_label}"><i class="fa fa-angle-double-right"></i></a></li>';
$NEXTPREV_TEMPLATE['bootstrap_nav_next'] 		= '<li><a class="next" href="{url}" title="{url_label}"><i class="fa fa-angle-right"></i></a></li>';
