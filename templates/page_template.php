...
<div class="clear"><!-- --></div>
{CPAGERATING|default}
<div class="btn-group cpage-social">{PRINTICON: class=btn btn-default}{PDFICON}{SOCIALSHARE}{CPAGEEDIT: class=btn btn-default}</div>
'; 
...
$PAGE_TEMPLATE['default']['end'] = '
  {CPAGERELATED:limit=3&types=page}
</div>'; 
